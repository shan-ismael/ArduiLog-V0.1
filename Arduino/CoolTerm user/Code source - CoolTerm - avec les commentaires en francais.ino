/* 
 ...
 Code source pour les utilisateurs de CoolTerm - avec les commentaires en francais
...
char* input_unit[48]; // unité de vos entrées analogiques pour l'écran LCD

// Uniquement les valeurs ci-dessous sont envoyées vers CoolTerm et l'écran LCD
...
void setup()
{
  ...
  /* 
   ...
   pour l'affichage de l'écran LCD
