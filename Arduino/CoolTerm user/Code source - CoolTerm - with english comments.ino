/* 
 ...
 CoolTerm users code - with english comments
...
/*
 Thanks to Mayhew Lab : http://mayhewlabs.com/arduino-mux-shield
 for multiplexer code.
 
 Thanks to Maurice Ribble
 http://www.glacialwanderer.com/hobbyrobotics
 for DS1307 RTC code.
 
 Thanks to my friend Edouard Chalouhb : http://www.edouard-chalhoub.com/
 to provide me a lab to test ArduiLog v0.1 in real process.
 */
...
int analog_input[48]; // Raw analog input of multiplexer (0 to 1023)
...
void setup()
{
  ...
  /*
   Set analogs inputs units for LCD display (Pa,°C,V,mA,A ....)
...
void analogs_map(){
  ...
  // Voltage conversion, convert all analogs inputs from [0;1023] numeric to [0;30]V
  for (int i=0; i<48; i++){
...
void datalog(){
  // Send values in message format to CoolTerm, to export data in *.txt format (to change to *.csv format)
